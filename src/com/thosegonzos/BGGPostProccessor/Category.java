...
public class Category 
{
	...
	private ArrayList<String> getCategoryMatrix(String strLine) 
	{
		...
		if (categoryStr.contains("<("))
    	{
			...
			if (wargame)
			{
				tokenList.add(13, "True");
			}
			else
			{
				tokenList.add(13, "False");
			}
			if (fantasy)
			{
				tokenList.add(14, "True");
			}
			else
			{
				tokenList.add(14, "False");
			}	
			if (economic)
			{
				tokenList.add(15, "True");
			}
			else
			{
				tokenList.add(15, "False");
			}		
			if (childrens)
			{
				tokenList.add(16, "True");
			}
			else
			{
				tokenList.add(16, "False");
			}	
			if (fighting)
			{
				tokenList.add(17, "True");
			}
			else
			{
				tokenList.add(17, "False");
			}	
			if (abstractStrategy)
			{
				tokenList.add(18, "True");
			}
			else
			{
				tokenList.add(18, "False");
			}	
			if (sciFi)
			{
				tokenList.add(19, "True");
			}
			else
			{
				tokenList.add(19, "False");
			}	
			if (wwii)
			{
				tokenList.add(20, "True");
			}
			else
			{
				tokenList.add(20, "False");
			}	
			if (dice)
			{
				tokenList.add(21, "True");
			}
			else
			{
				tokenList.add(21, "False");
			}	
			if (party)
			{
				tokenList.add(22, "True");
			}
			else
			{
				tokenList.add(22, "False");
			}	
			if (bluffing)
			{
				tokenList.add(23, "True");
			}
			else
			{
				tokenList.add(23, "False");
			}	
			if (animals)
			{
				tokenList.add(24, "True");
			}
			else
			{
				tokenList.add(24, "False");
			}	
			if (humor)
			{
				tokenList.add(25, "True");
			}
			else
			{
				tokenList.add(25, "False");
			}	
			if (dexterity)
			{
				tokenList.add(26, "True");
			}
			else
			{
				tokenList.add(26, "False");
			}	
    	}
    	else
    	{
